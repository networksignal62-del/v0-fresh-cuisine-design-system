...
export function Header() {
  ...
  return (
    <>
      <div className="sticky top-0 z-50 bg-[#ffb40b] text-[#4a1f3d] py-2 px-4">
        <div className="container mx-auto flex items-center justify-center gap-2 text-sm md:text-base font-medium">
          <Phone className="w-4 h-4 md:w-5 md:h-5" />
          <span>Call this number to confirm your order:</span>
          <a href="tel:+23275361494" className="font-bold hover:underline">
            +232 75 361494
          </a>
        </div>
      </div>
