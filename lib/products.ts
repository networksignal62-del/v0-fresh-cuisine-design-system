...
export const products: Product[] = [
  ...
  },
  {
    ...
    description: "Rich and creamy groundnut soup",
    longDescription:
      "Traditional groundnut (peanut) soup cooked with meat and vegetables. Creamy, flavorful, and satisfying. A West African classic!",
    addOns: [
  ...
  },
  {
    ...
    price: 65,
    image: "/schweppes.jpg",
    description: "Schweppes Carbonated Soda Water",
    longDescription:
      "Classic Schweppes carbonated soda water. Crisp, refreshing, and perfect for mixing or enjoying on its own!",
    addOns: [],
    rating: 4.5,
    reviewCount: 98,
  },
  {
    ...
    price: 65,
    image: "/schweppes.jpg",
    description: "Schweppes Carbonated Tonic Water",
    longDescription:
      "Refreshing Schweppes tonic water with that distinctive bitter-sweet taste. Perfect mixer or standalone refreshment!",
    addOns: [],
    rating: 4.5,
    reviewCount: 87,
  },
  ...
  },
  {
    ...
    price: 40,
    image: "/vita-milk.jpg",
    description: "Vita Milk Banana Soy Drink",
    longDescription:
      "Delicious Vita Milk banana flavored soy drink. 25% protein, enriched with vitamins and calcium. Nutritious and tasty!",
    addOns: [],
    rating: 4.8,
    reviewCount: 178,
  },
  {
    ...
    price: 40,
    image: "/vita-milk.jpg",
    description: "Vita Milk Double Choco Shake",
    longDescription:
      "Rich and creamy Vita Milk double chocolate shake. Double the chocolate, double the deliciousness! Enriched with vitamins.",
    addOns: [],
    rating: 4.9,
    reviewCount: 201,
  },
  {
    ...
    description: "Fontana Refreshing Pineapple Juice",
    longDescription:
      "Delicious Fontana pineapple juice in a convenient carton. Fresh, sweet, and refreshing tropical flavor!",
    addOns: [],
    rating: 4.7,
    reviewCount: 89,
  },
  {
    ...
    price: 85,
    image: "/fontana-juice.jpg",
    description: "Fontana Refreshing Cranberry Juice",
    longDescription: "Refreshing Fontana cranberry juice. Tangy, fruity, and perfect for any time of day!",
    addOns: [],
    rating: 4.6,
    reviewCount: 76,
  },
  {
    ...
    description: "Countre Banana Flavored Whole Milk",
    longDescription:
      "Delicious Countre banana flavored whole milk. Creamy, sweet, and packed with nutrients. Perfect for any time!",
    addOns: [],
    rating: 4.8,
    reviewCount: 134,
  },
  {
    ...
    price: 55,
    image: "/countre-milk.jpg",
    description: "Countre UHT Whole Milk",
    longDescription:
      "Fresh Countre whole milk. Rich, creamy, and 100% fresh. Great for drinking or adding to your favorite recipes!",
    addOns: [],
    rating: 4.7,
    reviewCount: 156,
  },
  {
    ...
    price: 55,
    image: "/countre-milk.jpg",
    description: "Countre Vanilla Full Cream Milk",
    longDescription: "Sweet and creamy Countre vanilla milk. Full cream goodness with a delightful vanilla flavor!",
    addOns: [],
    rating: 4.8,
    reviewCount: 112,
  },
  ...
  {
    id: 64,
    name: "Don Simon Tropical Juice",
    category: "drinks",
    price: 75,
    image: "/don-simon-juice.jpg",
    description: "Don Simon Tropical Juice 1L",
    longDescription: "Premium Don Simon tropical juice in a large 1L carton. Bursting with tropical fruit flavors!",
    addOns: [],
    rating: 4.7,
    reviewCount: 87,
  },
