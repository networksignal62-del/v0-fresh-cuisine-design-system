...
export const products: Product[] = [
  ...
  },
  {
    ...
    category: "african",
    price: 25,
    image: "/fried-fish-batter.jpg",
    description: "Crispy fish in batter",
    longDescription: "Fresh fish fillet coated in a light, crispy batter and fried to golden perfection. A delicious snack or side dish.",
    addOns: [
      { id: 111, name: "Extra Sauce", price: 5 },
    ],
  },
  {
    id: 65,
